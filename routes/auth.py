...
class UserRegister(Resource):
    @auth_ns.doc(description='''Register a new user account with optional file uploads.
...
- id_front: Front ID document file (driver's license, passport, etc.)
- id_back: Back ID document file
